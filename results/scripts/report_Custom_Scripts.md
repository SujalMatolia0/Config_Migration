...
- **URLs / Endpoints:** `https://js.arcgis.com/4.20/esri/themes/light/main.css`, `https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js`, `https://js.arcgis.com/4.20/`
