...
> [!NOTE]
> Server-side PHP script (`cityworksapicall.php`) that executes 3 internal OSVC database/Connect PHP operation(s), integrates with 1 external REST HTTP service(s). Primary entity target(s): Configuration.
