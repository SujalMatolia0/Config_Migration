...
flowchart LR
  subgraph MOD_Contact ["Module: Contact"]
    ...
    N_workspacefield_title["Title (workspacefield)"]
    N_workspacefield_addr["Addr (workspacefield)"]
    N_workspacefield_phoffice["PhOffice (workspacefield)"]
    N_workspacefield_c_customerid["C$CustomerId (workspacefield)"]
    N_workspace_contact -->|"field"| N_workspacefield_title
    N_workspace_contact -->|"field"| N_workspacefield_addr
    N_workspace_contact -->|"field"| N_workspacefield_phoffice
    N_workspace_contact -->|"field"| N_workspacefield_c_customerid
  end
```

| Component ID / Name | Type | Dependencies (In -> Out) | Details & Execution Context |
| :--- | :--- | :---: | :--- |
| `Contact` | `object` | `0 in -> 53 out` | Primary OSVC Entity Module Schema Root |
...
| `Addr` | `workspacefield` | `6 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `C$CustomerId` | `workspacefield` | `2 in -> 0 out` | Custom Field (c$) | Data Type: `Data Field` |
| `C$Gender` | `workspacefield` | `6 in -> 0 out` | Custom Field (c$) | Data Type: `Data Field` |
...
| `CtypeId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `PhOffice` | `workspacefield` | `6 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Title` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
...
flowchart LR
  subgraph MOD_Contact_test ["Module: Contact test"]
    N_workspacefield_name_first["Name.First (workspacefield)"]
    N_workspacefield_name_last["Name.Last (workspacefield)"]
    N_workspacefield_email["Email (workspacefield)"]
    N_workspacefield_orgid["OrgId (workspacefield)"]
    N_workspacefield_c_isregistered["C$IsRegistered (workspacefield)"]
    N_workspacefield_disabled["Disabled (workspacefield)"]
  end
```

| Component ID / Name | Type | Dependencies (In -> Out) | Details & Execution Context |
| :--- | :--- | :---: | :--- |
| `C$IsRegistered` | `workspacefield` | `1 in -> 0 out` | Custom Field (c$) | Data Type: `Data Field` |
| `CId` | `workspacefield` | `3 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Disabled` | `workspacefield` | `1 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Email` | `workspacefield` | `7 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Name.First` | `workspacefield` | `5 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Name.Last` | `workspacefield` | `5 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `OrgId` | `workspacefield` | `3 in -> 0 out` | Standard Field | Data Type: `Data Field` |
...
### Entity Module: Incident (39 Mapped Components)
...
flowchart LR
  subgraph MOD_Incident ["Module: Incident"]
    ...
    N_workspacefield_prodid["ProdId (workspacefield)"]
    N_workspacefield_status_id["Status.Id (workspacefield)"]
    N_workspacefield_subject["Subject (workspacefield)"]
    N_workspacefield_chanid["ChanId (workspacefield)"]
    N_workspacefield_catid["CatId (workspacefield)"]
    N_workspace_incident -->|"field"| N_workspacefield_prodid
    N_workspace_incident -->|"field"| N_workspacefield_status_id
    N_workspace_incident -->|"field"| N_workspacefield_subject
    N_workspace_incident -->|"field"| N_workspacefield_chanid
    N_workspace_incident -->|"field"| N_workspacefield_catid
  end
```

| Component ID / Name | Type | Dependencies (In -> Out) | Details & Execution Context |
| :--- | :--- | :---: | :--- |
| `Incident` | `object` | `0 in -> 30 out` | Primary OSVC Entity Module Schema Root |
...
| `Assigned` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `CatId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `ChanId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
...
| `InterfaceId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `LangId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Login` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `MailboxId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `MaMailType` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `MaOptIn` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `ProdId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `QueueId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `RefNo` | `workspacefield` | `1 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `SlaiId` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Source` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `State` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Status.Id` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
| `Subject` | `workspacefield` | `2 in -> 0 out` | Standard Field | Data Type: `Data Field` |
...
### Entity Module: New workspace (1 Mapped Components)

| Component ID / Name | Type | Dependencies (In -> Out) | Details & Execution Context |
| :--- | :--- | :---: | :--- |
| `C$AccountNumber` | `workspacefield` | `2 in -> 0 out` | Custom Field (c$) | Data Type: `Data Field` |
...
| :--- | :--- | :---: | :--- | :---: |
| `Title` | `Standard` | No | Main Tab | `2 in -> 0 out` |
| `Name.First` | `Standard` | No | Main Tab | `5 in -> 0 out` |
| `Name.Last` | `Standard` | No | Main Tab | `5 in -> 0 out` |
| `Addr` | `Standard` | No | Main Tab | `6 in -> 0 out` |
| `PhOffice` | `Standard` | No | Main Tab | `6 in -> 0 out` |
| `C$CustomerId` | `Standard` | Yes (c$) | Main Tab | `2 in -> 0 out` |
| `Email` | `Standard` | No | Main Tab | `7 in -> 0 out` |
| `CtypeId` | `Standard` | No | Main Tab | `2 in -> 0 out` |
| `C$Gender` | `Standard` | Yes (c$) | Main Tab | `6 in -> 0 out` |
