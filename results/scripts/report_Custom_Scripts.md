...
- **URLs / Endpoints:** `https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js`, `https://js.arcgis.com/4.20/esri/themes/light/main.css`, `https://js.arcgis.com/4.20/`
...
- **URLs / Endpoints:** `https://cdn.datatables.net/1.10.20/css/jquery.dataTables.css`, `https://use.fontawesome.com/releases/v5.1.1/css/all.css`, `https://cdn.datatables.net/1.10.20/js/jquery.dataTables.js`
